...
onMounted(() => {
  // Ascolta l'evento 'inertia:visit' per sapere quando i dati della pagina sono stati caricati
  // window.$inertia.on('inertia:visit', (event) => {
  ...
  >
    <slot>
      ...
      <div class="content-header">
        <slot name="header">
          <!-- Logo -->
          <Link :href="route('home')" class="fw-semibold text-dual">
